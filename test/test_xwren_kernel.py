...
class KernelTests(jupyter_kernel_test.KernelTests):
    ...
    code_hello_world = 'System.print("hello, world")'
    # code_page_something = "?"
    # completion_samples = [
    ...
    def test_stdout(self):
        ...
        reply, output_msgs = self.execute_helper(code='System.print("hello, world")')
        self.assertEqual(output_msgs[0]['msg_type'], 'stream')
        self.assertEqual(output_msgs[0]['content']['name'], 'stdout')
        self.assertEqual(output_msgs[0]['content']['text'], 'hello, world')

    # def test_stderr(self):
    #     reply, output_msgs = self.execute_helper(code='a=a')
    #     self.assertEqual(output_msgs[0]['msg_type'], 'stream')
